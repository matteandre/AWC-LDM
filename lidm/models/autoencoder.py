...
class LQModel(pl.LightningModule):
    def __init__(self,
        ...
        self.quantize = LQQuantizer(embed_dim, n_embed, **ddconfig.codebook)
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        x_rec, qloss = self(x, return_pred_indices=True)
...
class LQModelInterface(LQModel):
...
class IdentityFirstStage(torch.nn.Module):
    def __init__(self, *args, lq_interface=False, **kwargs):
        self.lq_interface = lq_interface
        super().__init__()
